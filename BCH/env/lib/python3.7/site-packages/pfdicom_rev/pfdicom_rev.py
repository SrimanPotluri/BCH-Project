...
class pfdicom_rev(pfdicom.pfdicom):
    ...
    def externalExecutables_set(self):
        ...
        """
        self.exec_dcm2jpgConv           = '/usr/local/bin/dcmj2pnm'
        self.exec_jpgResize             = '/usr/local/bin/mogrify'
        self.exec_jpgPreview            = '/usr/local/bin/convert'
        self.exec_dcmAnon               = '/usr/local/bin/dcmodify'
